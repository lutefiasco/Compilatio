# Compilatio Initial Development Plan

Historical record of the initial development phases (January 2026).
...
See [British Library Import Plan](archived/2026-01-27-British-Library-Import.md) for details.
...
See [Additional Repositories Import Plan](archived/2026-01-28-Additional-Repositories-Import.md) for full details.
...
See [Huntington Ellesmere Import Plan](archived/2026-01-29-Huntington-Ellesmere-Import.md) for details.
...
## Viewer Design Issues (Historical)
